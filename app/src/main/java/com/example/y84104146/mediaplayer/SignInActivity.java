        ...
        loginIn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(TextUtils.isEmpty(mPasswordView.getText()) || TextUtils.isEmpty(mPhoneView.getText())){
                    Toast.makeText(getApplicationContext(),"用户名及密码不能为空",Toast.LENGTH_SHORT).show();
                }else{
//                     创建数据库
//                    LitePal.getDatabase();
//gcrjfduib
//                    查询数据库v
                    ...
                    for(UserInfo userInfo: userInfos){
                        ...
                        String databasePhone = userInfo.getTelePhoneNumber().toString().trim();
                        String databasePassword = userInfo.getPassword().toString().trim();
                        if(inputPhoneNumber.equals(databasePhone) && inputPassword.equals(databasePassword)){
                            userNikeName = userInfo.getNikeName().toString().trim();
                            Intent intent = new Intent(SignInActivity.this, MainActivity.class);
                            startActivity(intent);
                        }
                        Log.d("SignInActivity","id is "+ userInfo.getTelePhoneNumber());
                        Log.d("SignInActivity","nickname is " + userInfo.getNikeName());
                        Log.d("SignInActivity","password is " + userInfo.getPassword());
                    }
...
//
//
//                            Log.d("SignInActivity","id is "+ id);
//                            Log.d("SignInActivity","nickname is " + nickname);
...
//                    cursor.close();
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(email)) {
            mPhoneView.setError(getString(R.string.phone_cannot_empty));
